...
public class BasicMockup {
     ...
     public void mainBM() {
        Runnable r = new Runnable() {
            ...
            public void run() {
                ...
                BasicMockup bp = new BasicMockup();

                JFrame f = new JFrame("Herramienta Mockup");
    ...
    private JLabel output = new JLabel("Herramienta Mockup");
    ...
    public JComponent getGui() {
        if (gui==null) {
            ...
            colorButton.setToolTipText("Escoge a Color");
            ActionListener colorListener = new ActionListener() {
                public void actionPerformed(ActionEvent arg0) {
                    Color c = JColorChooser.showDialog(
                            gui, "Escoge a color", color);
                    if (c!=null) {
                        setColor(c);
                    }
                }
            ...
            JLabel strokeLabel = new JLabel("Grosor");
            ...
            final JRadioButton select = new JRadioButton("Seleccionar", true);
            final JRadioButton draw = new JRadioButton("Dibujar");
            final JRadioButton text = new JRadioButton("Texto");
    ...
    private JMenu getFileMenu(boolean webstart){
        ...
        JMenuItem newImageItem = new JMenuItem("Nuevo");
        ...
        if (webstart) {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (result==JFileChooser.APPROVE_OPTION ) {
                        try {
                            ...
                            ImageIO.write(BasicMockup.this.canvasImage, "png", f);
                            BasicMockup.this.originalImage = BasicMockup.this.canvasImage;
                            dirty = false;
            ...
            ActionListener UseCaseListener = new ActionListener() {
            ...
            JMenuItem UsecItem = new JMenuItem("Generar Caso de Uso");
            UsecItem.addActionListener(UseCaseListener);
            UsecItem .setMnemonic('m');
            file.add(UsecItem);
    ...
    public JFileChooser getFileChooser() {
        if (chooser==null) {
            ...
            FileFilter ff = new FileNameExtensionFilter("Archivos de Imagen", ImageIO.getReaderFileSuffixes());
    ...
    public void text(Point point) {
        String text = JOptionPane.showInputDialog(gui, "Texto para aggregar", "Text");
        if (text!=null) {
            Graphics2D g = this.canvasImage.createGraphics();
            g.setRenderingHints(renderingHints);
    ...
    class ImageMouseListener extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent arg0) {
            // TODO Auto-generated method stub
            if (activeTool==BasicMockup.SELECTION_TOOL) {
                selectionStart = arg0.getPoint();
            } else if (activeTool==BasicMockup.DRAW_TOOL) {
                // TODO
                draw(arg0.getPoint());
            } else if (activeTool==BasicMockup.TEXT_TOOL) {
                // TODO
                text(arg0.getPoint());
            } else {
                JOptionPane.showMessageDialog(
